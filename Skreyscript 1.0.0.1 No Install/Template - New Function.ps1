...
{<#
	...
	.PARAMETER param3
		A description of the param3 parameter.
	
	.EXAMPLE
				PS C:\> My-Function -param1 'Value1' -param2
	...
	.NOTES
	    ...
	    param(
		    [Parameter(ParameterSetName = 'Param Set 1',
				       Mandatory = $true,
				       ValueFromPipeline = $true,
				       Position = 0,
				       HelpMessage = 'Quick help param1')]
		    [ValidateNotNullOrEmpty()]
		    [System.String]$param1 = 'This is a string',
		
		    [Parameter(ParameterSetName = 'Param Set 2',
				       Mandatory = $false,
				       ValueFromPipeline = $true,
				       ValueFromPipelineByPropertyName = $true,
				       ValueFromRemainingArguments = $true,
				       Position = 1,
				       HelpMessage = 'Param2 help message')]
		    [switch]$param2,
		    $param3
		    )
